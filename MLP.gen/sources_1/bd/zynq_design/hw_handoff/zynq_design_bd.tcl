...
proc create_root_design { parentCell } {
  ...
  # Create instance: MLPHLS_Opt_0, and set properties
  set MLPHLS_Opt_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:MLPHLS_Opt:1.0 MLPHLS_Opt_0 ]

  # Create instance: MLP_RTL_IP_0, and set properties
  set MLP_RTL_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:MLP_RTL_IP:1.0 MLP_RTL_IP_0 ]
  ...
  connect_bd_intf_net -intf_net MLPHLS_Opt_0_M_AXIS [get_bd_intf_pins MLPHLS_Opt_0/M_AXIS] [get_bd_intf_pins axi_fifo_mm_s_1/AXI_STR_RXD]
  connect_bd_intf_net -intf_net MLP_RTL_IP_0_M_AXIS [get_bd_intf_pins MLP_RTL_IP_0/M_AXIS] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD]
  connect_bd_intf_net -intf_net axi_fifo_mm_s_0_AXI_STR_TXD [get_bd_intf_pins MLP_RTL_IP_0/S_AXIS] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD]
  connect_bd_intf_net -intf_net axi_fifo_mm_s_1_AXI_STR_TXD [get_bd_intf_pins MLPHLS_Opt_0/S_AXIS] [get_bd_intf_pins axi_fifo_mm_s_1/AXI_STR_TXD]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins MLPHLS_Opt_0/ap_clk] [get_bd_pins MLP_RTL_IP_0/ACLK] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_1/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins MLPHLS_Opt_0/ap_rst_n] [get_bd_pins MLP_RTL_IP_0/ARESETN] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_1/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
