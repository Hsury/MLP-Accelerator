...
HD_PWD='D:/Lab/MLP/MLP.runs/zynq_design_MLPHLS_Opt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_MLPHLS_Opt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_MLPHLS_Opt_0_0.tcl
